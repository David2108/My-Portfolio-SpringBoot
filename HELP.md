...
* The original package name 'com.portfolio.my_portfolio-backend' is invalid and this project uses 'com.portfolio.my_portfolio_backend' instead.
...
* [Spring Data JDBC](https://docs.spring.io/spring-boot/3.5.16/reference/data/sql.html#data.sql.jdbc)
